...
export function UserProfileDrop() {
  const [position, setPosition] = React.useState("bottom")

  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="none" className="w-fit h-fit flex gap-3 p-0 ">
            <Avatar className="w-10 h-10 bg-red-200">
                <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
                <AvatarFallback>CN</AvatarFallback>
            </Avatar>
            <div className="hidden tracking-[-0.32px] text-[#1a202c] text-base md:block">
                {"John Corners"}
            </div>
            <ChevronDown className="hidden md:block" color="#1a202c"/>
        </Button>
      </DropdownMenuTrigger>
            ...
            <div id="toast-notification" class="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300" role="alert">
                ...
                <div class="flex items-center">
                    <div class="relative inline-block shrink-0">
                        <img class="w-12 h-12 rounded-full" src="https://github.com/shadcn.png" alt="Jese Leos image"/>
