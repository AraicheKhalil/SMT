...
const InputPassword = ({
  ...
  return (
    <div
      className={`relative flex-grow basis-[350px] text-left ${inptWraperClasses}`}
    >
      {isLabeled && (
        <label
          htmlFor={id}
      ...
      <input
        ...
        onBlur={onBlur}
        className={`py-2 px-3 text-[12px] sm:text-[14px] xl:text-[16px] border border-gray-300 w-full rounded-md  ${inputClasses}`}
      />
      <button
        type="button"
